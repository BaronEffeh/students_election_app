...
//   const handleVote = () => {
//     if (!selectedCandidateId) {
//       alert('Please select a candidate or skip.');
//       return;
//     }
...
//       .filter(([_, candidate]) => candidate) // skip null/empty votes
...
//                 <Box display="flex" justifyContent="space-between" mt={4} gap={1}>
//                   <Button
//                     variant="outlined"
//                     onClick={handleBack}
//                     disabled={currentPositionIndex === 0}
...
//                           </Box>
//                         ) : (
//                           <Typography color="text.secondary" fontStyle="italic">Skipped</Typography>
//                         )}
//                       </Box>
//                     );
//                   })}
...
//           <CircularProgress sx={{ color: '#FFD700' }} />
//           <Typography mt={2} fontWeight={500}>Loading positions and candidates...</Typography>
//         </Box>
//       </Container>
//     );
//   }
